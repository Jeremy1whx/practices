...
- ### Matching Engine – 4M+ orders/sec with 100ns P99 match latency
...
- ### Event Bus – 6.9M+ events/sec with 197ns per-event latency
...
- ### Persistence & Replay – Journaling and state recovery (in progress)
